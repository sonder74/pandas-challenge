...
## Tools and Solutions
With my **Heroes of Pymoli** project, I had my first opportunity to use what have since become two of my favorite data-analyis tools: Jupyter Notebooks and Python's Pandas library. I used them to access a large set of fantasy-game purchasing data and to create a long series of Pandas dataframes. Together, these dataframes and the Python logic that I wrote helped me to visualize sales trends, customer demographics, purchasing behavior, and more.